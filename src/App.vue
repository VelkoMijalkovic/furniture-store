<template>
  <div>
    <header class="header">
      ...
      <div class="icons">
        <div id="menu-btn">
          <font-awesome-icon icon="bars" @click="menu" size="1x"></font-awesome-icon>
        </div>
        <div id="search-btn">
          <font-awesome-icon icon="search" @click="searchbtn" size="1x"></font-awesome-icon>
        </div>
        <div id="cart-btn">
          <font-awesome-icon icon="shopping-cart" @click="cartbtn" size="1x"></font-awesome-icon>{{ totalItems }}
        </div>
        <div id="login-btn">
          <font-awesome-icon icon="user" @click="loginbtn" size="1x"></font-awesome-icon>
        </div>
      </div>
    </header>
    <div id="closer">
      <font-awesome-icon icon="times" @click="closer" size="1x"></font-awesome-icon>
    </div>
    <nav class="navbar">
    ...
    <div class="shopping-cart">
      <div class="box" v-for="product in products" :key="product">
        <i class="fa-times">
          <font-awesome-icon icon="times" size="1x" @click="removeProduct(product)"></font-awesome-icon>
        </i>
      ...
      <h3 class="total">total: <span>R {{ total.toFixed(2) }}</span></h3>
    ...
    <ShopPage v-if="visibleShop" @totalCart="cartItems" @additionalProducts="cartProducts" :numberOfProducts="totalItems"/>
